...
export default function OnlineOrder() {
  ...
  const kot = async (creadential, itemdetail) => {
    await localStorage.setItem("onlinekot", JSON.stringify([cartItem, creadential, itemdetail]));
        ...
        <main className="">
          <div className="h-[90vh] overflow-auto">
            <div className=" flex-row lg:flex justify-between px-2 py-5 md:px-8 lg:px-4 lg:py-2">
              ...
              <div className="flex w-full">
                <OnlineCart cartItem={cartItem} removeItem={removeItem} inCrese={inCrese} deCrese={deCrese} billing={billing} kot={kot} tital="Online Order" />
              </div>
            </div>
            {showBillingPopup ? (
              <>
